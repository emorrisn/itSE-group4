  ...
  <div class="app">
    <div class="bg-gray-50 h-screen">
      <div class="flex relative isolate px-6 lg:px-8 min-h-full justify-center">
        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
          <div class="group relative flex gap-x-6 rounded-xl shadow-xl bg-white p-4 items-center hover:bg-green-50 transition ease-in-out">
        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
          <div class="group relative flex gap-x-6 rounded-xl shadow-xl bg-white p-4 items-center hover:bg-red-50 transition ease-in-out">
            ...
            <div>
              <a href="/my/account" class="font-semibold text-gray-900">
                Account
                <span class="absolute inset-0"></span>
              </a>
              <p class="text-gray-600">Manage your account settings and contact info</p>
